...
async function main() {
  console.log("🌱 Precargando autores, libros y usuario admin...");
  ...
  await prisma.book.createMany({
    data: [
      ...
      { title: "Design Patterns: Elements of Reusable Object-Oriented Software", price: 1800, imageUrl: "https://m.media-amazon.com/images/I/51kuc0iWo8L.jpg", authorId: gamma.id },
